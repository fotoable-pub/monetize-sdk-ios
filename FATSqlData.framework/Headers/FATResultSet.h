...
@interface FATResultSet : NSObject {
    FATDatabase          *_parentDB;
    FATStatement         *_statement;
...
@property (atomic, retain) FATStatement *statement;
...
+ (instancetype)resultSetWithStatement:(FATStatement *)statement usingParentDatabase:(FATDatabase*)aDB;

/** Close result set */

- (void)close;

- (void)setParentDB:(FATDatabase *)newDb;
