...
@interface FATDatabase : NSObject  {
...
- (FATResultSet *)executeQuery:(NSString*)sql, ...;
...
- (FATResultSet *)executeQueryWithFormat:(NSString*)format, ... NS_FORMAT_FUNCTION(1,2);
...
- (FATResultSet *)executeQuery:(NSString *)sql withArgumentsInArray:(NSArray *)arguments;
...
- (FATResultSet *)executeQuery:(NSString *)sql withParameterDictionary:(NSDictionary *)arguments;


// Documentation forthcoming.
- (FATResultSet *)executeQuery:(NSString*)sql withVAList: (va_list)args;
...
@interface FATStatement : NSObject {
